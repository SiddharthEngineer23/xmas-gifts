...
def main():
    ...
    user_name = st.text_input("Enter your name:", value="Siddharth")
    ...
    if page == "Create My Wishlist":
        ...
        item = st.text_input("Item Name:", value="Socks")
        description = st.text_input("Description:", value="8 is my shoe size")
        link = st.text_input("Link:", value="amazon.com/cool-guy-socks")
